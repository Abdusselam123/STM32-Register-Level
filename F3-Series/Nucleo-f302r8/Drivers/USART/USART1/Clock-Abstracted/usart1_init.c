/*
 * @file usart1_init.c
 * @brief STM32 USART1 register-level initialization implementation (compile-time, bare-metal, no HAL/LL)
 */
...
void USART1_Init(){
	...
	//USART1_TX_PIN RESET & AF
	USART1_TX_PORT->MODER &= ~(3<<(USART1_TX_PIN*2));
	USART1_TX_PORT->MODER |= (2<<(USART1_TX_PIN*2));
	//USART1_RX_PIN RESET & AF
	USART1_RX_PORT->MODER &= ~(3<<(USART1_RX_PIN*2));
	USART1_RX_PORT->MODER |= (2<<(USART1_RX_PIN*2));

	if(USART1_TX_PIN<8){
		//TX_PIN RESET
		USART1_TX_PORT->AFR[0] &= ~(0xF<<(USART1_TX_PIN*4));
		//TX_PIN SET
		USART1_TX_PORT->AFR[0] |= (USART1_AF_VALUE<<(USART1_TX_PIN*4));
	}
		else{
			uint8_t shift_amount_1 = (uint8_t)((USART1_TX_PIN - 8) * 4);
			//TX_PIN RESET
			USART1_TX_PORT->AFR[1] &= ~(0xF<<shift_amount_1);
			//TX_PIN SET
			USART1_TX_PORT->AFR[1] |= (USART1_AF_VALUE<<shift_amount_1);
		}

	if(USART1_RX_PIN<8){
			//TX_PIN RESET
			USART1_RX_PORT->AFR[0] &= ~(0xF<<(USART1_RX_PIN*4));
			//TX_PIN SET
			USART1_RX_PORT->AFR[0] |= (USART1_AF_VALUE<<(USART1_RX_PIN*4));
		}
			else{
				uint8_t shift_amount_2 = (uint8_t)((USART1_RX_PIN - 8) * 4);
				//TX_PIN RESET
				USART1_RX_PORT->AFR[1] &= ~(0xF<<shift_amount_2);
				//TX_PIN SET
				USART1_RX_PORT->AFR[1] |= (USART1_AF_VALUE<<shift_amount_2);
			}


	//USART SETTINGS
	USART1->BRR  = (USART1_BUS_CLOCK_HZ + (USART1_TARGET_BAUDRATE/2))/USART1_TARGET_BAUDRATE; //8MHZ/BAUDRATE
...
static inline void Enable_Usart_GPIO_Clock(void){
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_A_ID)
		//for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_B_ID)
		//for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_C_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_D_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_E_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_F_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_G_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_H_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_I_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_J_ID)
	    //for f3 series
	...
	#if (USART1_TX_SELECTED_PORT_ID == USART1_PORT_K_ID)
	    //for f3 series
	...
	// Enable Clock for Port A
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_A_ID)
		//for f3 series
	    #if defined(RCC_AHBENR_GPIOAEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOA);
	    #elif defined(RCC_AHB1ENR_GPIOAEN)
	...
	// Enable Clock for Port B
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_B_ID)
		//for f3 series
	    #if defined(RCC_AHBENR_GPIOBEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOB);
	    #elif defined(RCC_AHB1ENR_GPIOBEN)
	...
	// Enable Clock for Port C
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_C_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOCEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOC);
	    #elif defined(RCC_AHB1ENR_GPIOCEN)
	...
	// Enable Clock for Port D
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_D_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIODEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOD);
	    #elif defined(RCC_AHB1ENR_GPIODEN)
	...
	// Enable Clock for Port E
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_E_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOEEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOE);
	    #elif defined(RCC_AHB1ENR_GPIOEEN)
	...
	// Enable Clock for Port F
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_F_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOFEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOF);
	    #elif defined(RCC_AHB1ENR_GPIOFEN)
	...
	// Enable Clock for Port G
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_G_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOGEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOG);
	    #elif defined(RCC_AHB1ENR_GPIOGEN)
	...
	// Enable Clock for Port H
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_H_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOHEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOH);
	    #elif defined(RCC_AHB1ENR_GPIOHEN)
	...
	// Enable Clock for Port I
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_I_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOIEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOI);
	    #elif defined(RCC_AHB1ENR_GPIOIEN)
	...
	// Enable Clock for Port J
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_J_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOJEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOJ);
	    #elif defined(RCC_AHB1ENR_GPIOJEN)
	...
	/// Enable Clock for Port K
	#if (USART1_RX_SELECTED_PORT_ID == USART1_PORT_K_ID)
	    //for f3 series
	    #if defined(RCC_AHBENR_GPIOKEN)
	        ENABLE_GPIO_CLOCK(AHBENR, GPIOK);
	    #elif defined(RCC_AHB1ENR_GPIOKEN)
...
static inline void Enable_Usart_Clock(void){
	...
	#if (SELECTED_USART1_ID == USART1_ID)
	    #if defined(RCC_AHBENR_USART1EN)
	        ENABLE_USART_CLOCK(AHBENR, USART1);
	    #elif defined(RCC_AHB1ENR_USART1EN)
	        ENABLE_USART_CLOCK(AHB1ENR, USART1);
		#elif defined(RCC_AHB2ENR_USART1EN)
	        ENABLE_USART_CLOCK(AHB2ENR, USART1);
		#elif defined(RCC_APBENR_USART1EN)
	        ENABLE_USART_CLOCK(APBENR, USART1);
		#elif defined(RCC_APB1ENR_USART1EN)
	        ENABLE_USART_CLOCK(APB1ENR, USART1);
		#elif defined(RCC_APB2ENR_USART1EN)
	        ENABLE_USART_CLOCK(APB2ENR, USART1);
		#endif
	#endif
